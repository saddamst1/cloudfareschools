...
export async function searchSchools(q, limit = 20, stateSlug = null, { category = null, mgmt = null, districtSlug = null } = {}) {
  ...
  // We ORDER BY lower(school_name) to allow Postgres/CockroachDB to scan the index directly in order.
  ...
  // We remove the ORDER BY clause on CockroachDB to enable early-exit index scans,
  // which makes contains searches on 1.6M rows up to 10x faster.
