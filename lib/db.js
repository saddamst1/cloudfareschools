...
async function initClient() {
  ...
  // We use array join here to prevent Next.js static dependency tracing (Node File Trace)
  // from bundling the 1.9GB local SQLite database file into the production serverless package.
  const dbPath = process.env.DB_PATH || [process.cwd(), 'data', 'schoolspedia.db'].join('/');
